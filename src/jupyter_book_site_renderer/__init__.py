...
class JupyterBookSiteRenderer(Application):
    """
    ...
    aliases = {
        **Application.aliases,
        "site": "JupyterBookSiteRenderer.site_path",
        "html": "JupyterBookSiteRenderer.html_path",
        "base-url": "JupyterBookSiteRenderer.base_url",
    }
    ...
    async def render(self):
        ...
        """
        site_path = Path(self.site_path)
        output_path = Path(self.html_path)
        ...
        await self.render_site_to_html(site_path, template_path, output_path, base_url)
